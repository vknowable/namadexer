...
pub fn get_drop_tx_bond_view_query(network: &str) -> String {
    format!("DROP VIEW IF EXISTS {network}.tx_bond;")
}
...
pub fn get_drop_tx_bridge_pool_view_query(network: &str) -> String {
    format!("DROP VIEW IF EXISTS {network}.tx_bridge_pool;")
}
...
pub fn get_drop_tx_change_consensus_key_view_query(network: &str) -> String {
    format!("DROP VIEW IF EXISTS {network}.tx_change_consensus_key;")
}
...
pub fn get_drop_tx_change_validator_comission_view_query(network: &str) -> String {
    format!("DROP VIEW IF EXISTS {network}.tx_change_validator_comission;")
}
...
pub fn get_drop_tx_change_validator_metadata_view_query(network: &str) -> String {
    format!("DROP VIEW IF EXISTS {network}.tx_change_validator_metadata;")
}
...
pub fn get_drop_tx_claim_rewards_view_query(network: &str) -> String {
    format!("DROP VIEW IF EXISTS {network}.tx_claim_rewards;")
}
...
pub fn get_drop_tx_deactivate_validator_view_query(network: &str) -> String {
    format!("DROP VIEW IF EXISTS {network}.tx_deactivate_validator;")
}
...
pub fn get_drop_tx_ibc_view_query(network: &str) -> String {
    format!("DROP VIEW IF EXISTS {network}.tx_ibc;")
}
...
pub fn get_drop_tx_init_account_view_query(network: &str) -> String {
    format!("DROP VIEW IF EXISTS {network}.tx_init_account;")
}
...
pub fn get_drop_tx_init_proposal_view_query(network: &str) -> String {
    format!("DROP VIEW IF EXISTS {network}.tx_init_proposal;")
}
...
pub fn get_drop_tx_reactivate_validator_view_query(network: &str) -> String {
    format!("DROP VIEW IF EXISTS {network}.tx_reactivate_validator;")
}
...
pub fn get_drop_tx_redelegate_view_query(network: &str) -> String {
    format!("DROP VIEW IF EXISTS {network}.tx_redelegate;")
}
...
pub fn get_drop_tx_resign_steward_view_query(network: &str) -> String {
    format!("DROP VIEW IF EXISTS {network}.tx_resign_steward;")
}
...
pub fn get_drop_tx_reveal_pk_view_query(network: &str) -> String {
    format!("DROP VIEW IF EXISTS {network}.tx_reveal_pk;")
}
...
pub fn get_drop_tx_transfert_view_query(network: &str) -> String {
    format!("DROP VIEW IF EXISTS {network}.tx_transfert;")
}

pub fn get_drop_tx_transfer_view_query(network: &str) -> String {
    format!("DROP VIEW IF EXISTS {network}.tx_transfer;")
}
...
pub fn get_drop_tx_unbond_view_query(network: &str) -> String {
    format!("DROP VIEW IF EXISTS {network}.tx_unbond;")
}
...
pub fn get_drop_tx_unjail_validator_view_query(network: &str) -> String {
    format!("DROP VIEW IF EXISTS {network}.tx_unjail_validator;")
}
...
pub fn get_drop_tx_update_account_view_query(network: &str) -> String {
    format!("DROP VIEW IF EXISTS {network}.tx_update_account;")
}
...
pub fn get_drop_tx_update_steward_commission_view_query(network: &str) -> String {
    format!("DROP VIEW IF EXISTS {network}.tx_update_steward_commission;")
}
...
pub fn get_drop_tx_vote_proposal_view_query(network: &str) -> String {
    format!("DROP VIEW IF EXISTS {network}.tx_vote_proposal;")
}
...
pub fn get_drop_tx_withdraw_view_query(network: &str) -> String {
    format!("DROP VIEW IF EXISTS {network}.tx_withdraw;")
}
